...
export default async function UserDetail({
  ...
  return (
    <div>
      ...
      <div className="flex lg:flex-row flex-col justify-center gap-8 mt-4 mx-4">
        <div>
          <Card className="bg-amber-200 ring-1 ring-amber-400 text-amber-800">
            ...
            <CardContent>
              <div className="flex flex-row p-2 m-2 pl-0 ml-0 mt-0">
                <h2 className="w-50 font-semibold text-l">NIK:</h2>
                <p>{data.user.nik}</p>
              </div>
              <div className="flex flex-row p-2 m-2 pl-0 ml-0">
