        ...
        <div className="bg-amber-200 w-[96%] px-6 py-4 h-full rounded-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-3 mt-4">
            <div className="flex flex-col gap-2">
              <label htmlFor="company_name" className="text-amber-800 text-xl">Company Name</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="company_owner" className="text-amber-800 text-xl">Company Owner</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="address" className="text-amber-800 text-xl">Address</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="email" className="text-amber-800 text-xl">Email Address</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="phone_number" className="text-amber-800 text-xl">Phone Number</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="web_url" className="text-amber-800 text-xl">Web URL</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="npwp" className="text-amber-800 text-xl">Tax ID / NPWP</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="payroll_date" className="text-amber-800 text-xl">Cut Off Payroll Date</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="status" className="text-amber-800 text-xl">Status</label>
              <select 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="" className="text-amber-800 text-xl">Upload Logo</label>
              <input 
